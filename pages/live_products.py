...
def render(project,report,repository):
 st.subheader('Live Products');st.caption('Live collection uses approved sources only. PostgreSQL remains the project source of truth.')
